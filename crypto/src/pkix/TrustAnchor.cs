...
namespace Org.BouncyCastle.Pkix
{
    ...
    public class TrustAnchor
    {
        ...
        {
            this.trustedCert = trustedCert ?? throw new ArgumentNullException(nameof(trustedCert));
            this.pubKey = null;
            this.caName = null;
        ...
        public TrustAnchor(X509Name caPrincipal, AsymmetricKeyParameter pubKey, byte[] nameConstraints)
        {
            ...
            this.caPrincipal = caPrincipal ?? throw new ArgumentNullException(nameof(caPrincipal));
        ...
        public TrustAnchor(string caName, AsymmetricKeyParameter pubKey, byte[] nameConstraints)
        {
            ...
            if (caName.Length == 0)
                throw new ArgumentException("can not be an empty string", nameof(caName));
