...
namespace Org.BouncyCastle.Cms
{
    internal class CmsSignedHelper
    {
		...
		static CmsSignedHelper()
		{
			...
			encryptionAlgs.Add(RosstandartObjectIdentifiers.id_tc26_gost_3410_12_256.Id, "ECGOST3410-2012-256");
			encryptionAlgs.Add(RosstandartObjectIdentifiers.id_tc26_gost_3410_12_512.Id, "ECGOST3410-2012-512");
        ...
        */
            ...
            string digestOID)
        {
            ...
            else if (key is ECPrivateKeyParameters)
            {
                ...
                else if (ecPrivKey.Parameters is ECGost3410Parameters)
                {
                    var gostParams = (ECGost3410Parameters)ecPrivKey.Parameters;
                    if (gostParams.DigestParamSet.Id == RosstandartObjectIdentifiers.id_tc26_gost_3411_12_256.Id)
                        encOID = CmsSignedGenerator.EncryptionECGost3410_2012_256;
                    else if (gostParams.DigestParamSet.Id == RosstandartObjectIdentifiers.id_tc26_gost_3411_12_512.Id)
