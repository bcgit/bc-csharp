...
namespace Org.BouncyCastle.Math.Raw
{
    internal static class Nat256
    {
        ...
        {
            return AddTo(x.AsSpan(xOff), z.AsSpan(zOff), cIn);
        }
        ...
        {
            x.AsSpan(xOff, 8).CopyTo(z.AsSpan(zOff));
        }
        ...
        public static uint Mul33DWordAdd(uint x, ulong y, uint[] z, int zOff)
        {
            ...
            z[zOff + 3] = (uint)c;
            c >>= 32;
            return c == 0 ? 0 : Nat.IncAt(8, z.AsSpan(zOff), 4);
        }
        ...
        public static uint Mul33WordAdd(uint x, uint y, uint[] z, int zOff)
        {
            ...
            z[zOff + 2] = (uint)c;
            c >>= 32;
            return c == 0 ? 0 : Nat.IncAt(8, z.AsSpan(zOff), 3);
        }
        ...
        {
            return SubFrom(x.AsSpan(xOff), z.AsSpan(zOff), cIn);
        }
