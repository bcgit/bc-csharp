...
namespace Org.BouncyCastle.Math.EC.Custom.Sec
{
        ...
        : AbstractFpCurve
    {
        ...
        public override int FieldElementEncodingLength => 16;

        public override int FieldSize => 128;
            ...
            : AbstractECLookupTable
        {
            ...
            {
                return m_outer.CreateRawPoint(new SecP128R1FieldElement(x), new SecP128R1FieldElement(y));
            }
        }
    }
}
