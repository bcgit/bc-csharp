...
namespace Org.BouncyCastle.Crypto.Operators
{
    internal class X509Utilities
    {
        ...
        static X509Utilities()
        {
            ...
            Algorithms.Add("RIPEMD128WITHRSAANDMGF1", PkcsObjectIdentifiers.IdRsassaPss);
            Algorithms.Add("RIPEMD160WITHRSAANDMGF1", PkcsObjectIdentifiers.IdRsassaPss);
            Algorithms.Add("RIPEMD256WITHRSAANDMGF1", PkcsObjectIdentifiers.IdRsassaPss);
            Algorithms.Add("SHA1WITHRSAANDMGF1", PkcsObjectIdentifiers.IdRsassaPss);
            Algorithms.Add("SHA224WITHRSAANDMGF1", PkcsObjectIdentifiers.IdRsassaPss);
            Algorithms.Add("SHA256WITHRSAANDMGF1", PkcsObjectIdentifiers.IdRsassaPss);
            Algorithms.Add("SHA384WITHRSAANDMGF1", PkcsObjectIdentifiers.IdRsassaPss);
            Algorithms.Add("SHA512WITHRSAANDMGF1", PkcsObjectIdentifiers.IdRsassaPss);
            Algorithms.Add("SHA3-224WITHRSAANDMGF1", PkcsObjectIdentifiers.IdRsassaPss);
            Algorithms.Add("SHA3-256WITHRSAANDMGF1", PkcsObjectIdentifiers.IdRsassaPss);
            Algorithms.Add("SHA3-384WITHRSAANDMGF1", PkcsObjectIdentifiers.IdRsassaPss);
            Algorithms.Add("SHA3-512WITHRSAANDMGF1", PkcsObjectIdentifiers.IdRsassaPss);
            ...
            ExParams.Add("RIPEMD128WITHRSAANDMGF1", CreatePssParams(ripeMD128AlgID, 16));

            var ripeMD160AlgID = new AlgorithmIdentifier(TeleTrusTObjectIdentifiers.RipeMD160, DerNull.Instance);
            ExParams.Add("RIPEMD160WITHRSAANDMGF1", CreatePssParams(ripeMD160AlgID, 20));

            var ripeMD256AlgID = new AlgorithmIdentifier(TeleTrusTObjectIdentifiers.RipeMD256, DerNull.Instance);
            ExParams.Add("RIPEMD256WITHRSAANDMGF1", CreatePssParams(ripeMD256AlgID, 32));
            ...
            AddAlgorithm("SHA3-224WITHPLAIN-ECDSA", BsiObjectIdentifiers.ecdsa_plain_SHA3_224, isNoParams: true);
