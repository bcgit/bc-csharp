...
namespace Org.BouncyCastle.Crypto.Tls
{
    ...
    public abstract class AbstractTlsKeyExchange : TlsKeyExchange
    {
        ...
        protected AbstractTlsKeyExchange(KeyExchangeAlgorithm keyExchange, IList supportedSignatureAlgorithms)
        {
                ...
                if (this.supportedSignatureAlgorithms == null)
                {
                    switch (keyExchange)
                    {
                        ...
                        case KeyExchangeAlgorithm.SRP_DSS:
                            {
                                this.supportedSignatureAlgorithms = TlsUtilities.GetDefaultDSSSignatureAlgorithms();
                                break;
                            }
                        ...
                        case KeyExchangeAlgorithm.ECDHE_ECDSA:
                            {
                                this.supportedSignatureAlgorithms = TlsUtilities.GetDefaultECDSASignatureAlgorithms();
                                break;
                            }
                        ...
                        case KeyExchangeAlgorithm.SRP_RSA:
                            {
                                this.supportedSignatureAlgorithms = TlsUtilities.GetDefaultRSASignatureAlgorithms();
                                break;
                            }
