...
namespace Org.BouncyCastle.Crypto.Tls
{
    ...
    internal class NamedCurveHelper
    {
        ...
        public static bool RefersToASpecificNamedCurve(NamedCurve namedCurve)
        {
            switch (namedCurve)
            {
                case NamedCurve.arbitrary_explicit_prime_curves:
                case NamedCurve.arbitrary_explicit_char2_curves:
                    return false;
                default:
                    return true;
            }
