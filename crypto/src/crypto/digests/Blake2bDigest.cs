...
namespace Org.BouncyCastle.Crypto.Digests
{
        ...
        : IDigest
    {
        ...
        private void Compress(ReadOnlySpan<byte> message)
        {
            ...
            {
                Blake2bSimd.Compress(f0 == ulong.MaxValue, chainValue, message, t0, t1, blake2b_IV);
                return;
            }
#endif
    ...
    internal static class Blake2bSimd
    {
        ...
        public static void Compress(bool isFinal, Span<ulong> hashBuffer, ReadOnlySpan<byte> dataBuffer, ulong totalSegmentsLow, ulong totalSegmentsHigh, ReadOnlySpan<ulong> blakeIV)
        {
            ...
            unchecked
            {
                ...
                ref ulong hash = ref MemoryMarshal.GetReference(hashBuffer);
                ref ulong iv = ref MemoryMarshal.GetReference(blakeIV);
