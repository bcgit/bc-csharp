        ...
        : DerStringBase
    {
        ...
        public static DerPrintableString GetInstance(object obj)
        {
            ...
            else if (obj is ArraySegment<byte>)
            {
                try
                {
                    return (DerPrintableString)Meta.Instance.FromByteArray((ArraySegment<byte>)obj);
                }
                catch (IOException e)
                {
                    throw new ArgumentException("failed to construct printable string from ArraySegment<byte>: " + e.Message);
                }
            }
