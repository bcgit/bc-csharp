        ...
        : DerStringBase
    {
        ...
        public static DerNumericString GetInstance(object obj)
        {
            ...
            else if (obj is ArraySegment<byte>)
            {
                try
                {
                    return (DerNumericString)Meta.Instance.FromByteArray((ArraySegment<byte>)obj);
                }
                catch (IOException e)
                {
                    throw new ArgumentException("failed to construct numeric string from ArraySegment<byte>: " + e.Message);
                }
            }
