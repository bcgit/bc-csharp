...
namespace Org.BouncyCastle.Pqc.Crypto.Hqc
{
    internal static class GFCalculator
    {
        ...
        internal static int Div(int a, int b) => Mul(a, Inv(b));

        internal static int Inv(int a) => _Inv[a];

        private static int Mod(int a)
        {
            int t = a - HqcParameters.GF_MUL_ORDER;
            //return t + ((t >> 31) & HqcParameters.GF_MUL_ORDER);
            return t + (int)((uint)t >> 24);
        }
        ...
        internal static int Sqr(int a) => _Sqr[a];
    }
}
