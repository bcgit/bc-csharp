...
namespace Org.BouncyCastle.Tests
{
        ...
        : SimpleTest
    {
        ...
        private static byte[] DerEncode(DerObjectIdentifier oid, byte[] hash) =>
            new DigestInfo(new AlgorithmIdentifier(oid, DerNull.Instance), hash).GetEncoded(Asn1Encodable.Der);

        public override string Name => "RSATest";
