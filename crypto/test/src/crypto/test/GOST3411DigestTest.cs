...
namespace Org.BouncyCastle.Crypto.Tests
{
        ...
        : DigestTest
    {
        ...
        public override void PerformTest()
        {
            ...
            KeyParameter key = new KeyParameter(PbeParametersGenerator.Pkcs5PasswordToUtf8Bytes("1".ToCharArray()));
        ...
        protected override IDigest CloneDigest(IDigest digest) => new Gost3411Digest((Gost3411Digest)digest);
