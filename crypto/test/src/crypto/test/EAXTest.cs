...
namespace Org.BouncyCastle.Crypto.Tests
{
        ...
        : SimpleTest
    {
        ...
        public override string Name => "EAX";
        ...
        private void CheckVectors(int count, string additionalDataType, byte[] k, int macSize, byte[] n, byte[] a,
            byte[] sa, byte[] p, byte[] t, byte[] c)
        {
        ...
        private void RunCheckVectors(int count, EaxBlockCipher encEax, EaxBlockCipher decEax, string additionalDataType,
            byte[] sa, byte[] p, byte[] t, byte[] c)
        {
        ...
        private void IVParamTest(int count, IAeadBlockCipher eax, byte[] k, byte[] n)
        {
