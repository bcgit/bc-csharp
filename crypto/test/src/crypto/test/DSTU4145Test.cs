...
namespace Org.BouncyCastle.Crypto.Tests
{
    ...
    public class Dstu4145Test
    {
        ...
        public void Test163()
        {
            ...
            F2mCurve curve = new F2mCurve(163, 3, 6, 7, BigInteger.One, new BigInteger("5FF6108462A2DC8210AB403925E638A19C1455D21", 16), null, null);
            ECPoint P = curve.CreatePoint(
            ...
            dstuSigner.Init(forSigning: true, privKey);
            BigInteger[] rs = dstuSigner.GenerateSignature(hash);

            Assert.AreEqual(r, rs[0], "r component wrong");
            Assert.AreEqual(s, rs[1], "s component wrong");

            dstuSigner.Init(forSigning: false, pubKey);
        ...
        public void Test173()
        {
            ...
            F2mCurve curve = new F2mCurve(173, 1, 2, 10, BigInteger.Zero, new BigInteger("108576C80499DB2FC16EDDF6853BBB278F6B6FB437D9", 16), null, null);
            ECPoint P = curve.CreatePoint(
                new BigInteger("BE6628EC3E67A91A4E470894FBA72B52C515F8AEE9", 16),
                new BigInteger("D9DEEDF655CF5412313C11CA566CDC71F4DA57DB45C", 16));
        ...
        public void Test283()
        {
            ...
            F2mCurve curve = new F2mCurve(283, 5, 7, 12, BigInteger.One, new BigInteger("27B680AC8B8596DA5A4AF8A19A0303FCA97FD7645309FA2A581485AF6263E313B79A2F5", 16), null, null);
            ECPoint P = curve.CreatePoint(
                new BigInteger("4D95820ACE761110824CE425C8089129487389B7F0E0A9D043DDC0BB0A4CC9EB25", 16),
                new BigInteger("954C9C4029B2C62DE35C2B9C2A164984BF1101951E3A68ED03DF234DDE5BB2013152F2", 16));
        ...
        public void Test431()
        {
            ...
            F2mCurve curve = new F2mCurve(431, 1, 3, 5, BigInteger.One, new BigInteger("3CE10490F6A708FC26DFE8C3D27C4F94E690134D5BFF988D8D28AAEAEDE975936C66BAC536B18AE2DC312CA493117DAA469C640CAF3", 16), null, null);
            ECPoint P = curve.CreatePoint(
                new BigInteger("9548BCDF314CEEEAF099C780FFEFBF93F9FE5B5F55547603C9C8FC1A2774170882B3BE35E892C6D4296B8DEA282EC30FB344272791", 16),
                new BigInteger("4C6CBD7C62A8EEEFDE17A8B5E196E49A22CE6DE128ABD9FBD81FA4411AD5A38E2A810BEDE09A7C6226BCDCB4A4A5DA37B4725E00AA74", 16));
