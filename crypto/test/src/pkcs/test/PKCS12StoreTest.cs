...
namespace Org.BouncyCastle.Pkcs.Tests
{
 ...
 + "LOhDDVV1zCxAAQ7XjkwCAgfQ");
        ...
        /// <summary>We generate a self signed certificate for the sake of testing - RSA.</summary>
        ...
        public void EmptyInputRejectedCleanly()
        {
            ...
            Assert.Throws<IOException>(() => store.Load(new MemoryStream(new byte[0]), "x".ToCharArray()));
        }
        ...
        [Test]
        public void MissingContentInfoContent()
        {
